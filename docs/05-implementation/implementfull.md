...
| Sprint | Name                   | Status      | Dependencies | Owner |
| :----- | :--------------------- | :---------- | :----------- | :---- |
| **0A** | Workspace Setup        | Completed   | None         | Jay   |
| **0B** | Backend Foundation     | Completed   | Sprint 0A    | Jay   |
| **0C** | UI Foundation          | Completed   | Sprint 0B    | Jay   |
| **1**  | Auth & Identity (BE)   | Completed   | Sprint 0B    | Jay   |
| **2**  | People & Students (BE) | Completed   | Sprint 1     | Jay   |
| **3**  | Frontend Platform UI   | Completed   | Sprint 2     | Jay   |
| **4**  | Responsive Polish      | Completed   | Sprint 3     | Jay   |
| **5**  | Master Data            | Active      | Sprint 4     | Jay   |
| **6**  | Learning               | Not Started | Sprint 5     | Jay   |
| **7**  | Live Classes           | Not Started | Sprint 6     | Jay   |
| **8**  | Assessments & QB       | Not Started | Sprint 7     | Jay   |
| **9**  | Billing                | Not Started | Sprint 8     | Jay   |
| **10** | Comms, Analytics & AI  | Not Started | Sprint 9     | Jay   |
| **11** | Production Go-Live     | Not Started | All Sprints  | Jay   |
...
_Columns: `Task ID`, `Phase`, `Task Description`, `Priority`, `Estimate (hrs)`, `Actual (hrs)`, `Variance`, `Status`, `Git Branch`, `PR Link`, `Issue Link`, `Remarks` | Metadata_
...
_Copy to Sheet: `16_release_checklist`_
...
_Copy to Sheet: `17_change_log`_
...
_Copy to Sheet: `18_risks_dependencies`_
