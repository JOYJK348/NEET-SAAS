...
- **Dunning Reminders Logic** → Fee Domain (`07-fee-management.md`) — The logic of _when_ to send an alert lives in Fee management. This domain only processes the message dispatch when requested.
