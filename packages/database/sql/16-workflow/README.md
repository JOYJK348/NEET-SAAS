...
1.  **Loose Coupling with Authorization**: Approvals are bound to system capability *permissions* (e.g. `exam.approve`, `admissions.approve`), never directly to hardcoded role IDs.
