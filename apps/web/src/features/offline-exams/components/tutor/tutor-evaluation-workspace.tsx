          ...
          <div className="shrink-0 flex items-center gap-1.5">
            {detail.answerKeySignedUrl && (
              <button
                ...
                className="px-2.5 py-1 bg-emerald-50 border border-emerald-200 text-emerald-700 hover:bg-emerald-100 text-[10px] font-extrabold rounded-xl flex items-center gap-1 transition cursor-pointer"
              >
                <FileCheck className="w-3 h-3 text-emerald-600" /> Answer Key
              </button>
            )}
            {isReadOnly ? (
